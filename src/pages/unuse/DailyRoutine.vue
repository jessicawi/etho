                ...
                <div v-if="selectedClassStudent&&selectedClassStudent.length>0" class="responsive-table col-lg-12">
                    <table class="attTable fullwidth">
                        ...
                        <tr v-for="(item,i) in selectedClassStudent" ref="studentList_Update"
                            ...
                            <td class="">
                                <el-select ref="studentCheckList" placeholder="Select" v-model="item.ddlRest"
                                           @change="(e)=>TaskDescription(e,item)">
                ...
                try {
                    ...
                    if (studentResponse) {
                        ...
                        for (let obj of tempStudent) {
                            ...
                            //     });
                            //     rest = tempRest.map(m => m.DrReferenceType);
                            //
                            //     let replaceRest = [];
                            //     rest.forEach(m => {
                            //         replaceRest.push(m.substring(5));
                            //     });
                            //     rest = replaceRest;
                            //
                            //     // Poop
